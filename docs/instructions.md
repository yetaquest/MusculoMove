...
2. It then fetches the backend manifest and loads the generated OpenSim GLTF.
3. The rendered model should come from the FullBodyModel bundle, not `avatar.glb`.
4. If the model asset cannot be loaded, the app falls back to debug geometry and shows a warning.
...
1. Active model: [models/FullBodyModel-4.0/Rajagopal2015.osim](/home/etekmen13/projects/MusculoMove/models/FullBodyModel-4.0/Rajagopal2015.osim)
